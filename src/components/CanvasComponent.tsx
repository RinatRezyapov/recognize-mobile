...
const CanvasComponent: React.FC<IProps> = ({ children }) => {
  ...
  return (
    <TouchableOpacity onPress={onClick}  style={{ position: 'absolute', zIndex: -10, top: 0, left: 0, width: '100%', height: '100%' }}>
      <SkiaView style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} onDraw={onDraw} mode="continuous" />
    </TouchableOpacity >
  );
}
